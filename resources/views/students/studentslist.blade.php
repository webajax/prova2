                ...
                <td style="text-align: center" colspan="2">
                    <div class="btn-group">
                        <div  class="col-sm-4 mr-3">
                            <button type="button" class="btn btn-default btn-sm  edit-student"  data-toggle="modal" data-target="#modal-students-edit" data-value="{{$students['id']}}"><i class="fas fa-edit"></i></button>
                        </div>
                        <div  class="col-sm-1">
