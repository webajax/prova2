                ...
                <div class="card card-primary card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="tab-company" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-company" data-toggle="pill" href="#custom-tabs-category" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Alunos</a>
                            </li>
                            ...
                            <div class="tab-pane fade active show" id="custom-tabs-category" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                ...
                                <div class="card"  >
                                    <div class="card-body div-list" style="position:relative;margin-top: -0.2%;overflow-y: auto;height: 520px;">
                                        ...
                                        @include('students.studentslist') <!--page list 'categorieslist.blade.php' ticket-->                                        
                                     </div>
                                </div>
                            <!--end-->
                            </div>
...
@include('students.studentsmodals') 
<script src="<?php echo URL::to('assets/system/js/global.js') ?>"></script><!--validate fields-->
<script src="<?php echo URL::to('assets/system/js/students/students.js') ?>"></script>
